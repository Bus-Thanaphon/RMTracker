...
{
    public class s_Edgebanding : BaseEntity
    {
        public string Id_Edgebanding { get; set; }
        ...
        public string Machine_Edgebanding { get; set; }
        [DisplayName("สถานะพิเศษ")]
        public string Special_status { get; set; }
        [DisplayName("สถานะ")]
        public string Status_Edgebanding { get; set; }
